// import { P as Parallax, S as Swiper } from "../vendor.688a9bfa.js";
// import { Parallax as Parallax, Swiper as Swiper } from "../vendor.688a9bfa.js";

function fashionSlider(g, swiperOptions) {
    if(!swiperOptions)swiperOptions = {};
    delete swiperOptions.on;
    ...
    ;
    let r;
    const onClickFashionBtnNext = ()=>{
        a || r.slideNext()
    }
      , onClickFashionBtnPrev = ()=>{
        a || r.slidePrev()
    }
      , x = e=>{
        e.el.querySelector(".fashion-slider-button-next").addEventListener("click", onClickFashionBtnNext),
        e.el.querySelector(".fashion-slider-button-prev").addEventListener("click", onClickFashionBtnPrev)
    }
      , E = e=>{
        e.el.querySelector(".fashion-slider-button-next").removeEventListener("click", onClickFashionBtnNext),
        e.el.querySelector(".fashion-slider-button-prev").removeEventListener("click", onClickFashionBtnPrev)
    }
    ;
    let y;
    return r = new Swiper(m,{
        // modules: [Parallax],
        // loop:!0,
        // autoplay: {
        //     delay: 2000,
